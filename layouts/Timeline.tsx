import Practo from '../public/static/images/practo.png'
import Image from 'next/image'
export default function Timeline() {
  return (
    <ol className="relative mt-10 border-s border-gray-200 dark:border-gray-700">
      <li className="mb-10 ms-6">
        <span className="absolute -start-10 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 ring-8 ring-white dark:bg-blue-900 dark:ring-gray-900">
          {/* <svg
          ...
          <Image src="/static/images/practo.png" alt="Practo Image" width={20} height={20} />
        </span>
